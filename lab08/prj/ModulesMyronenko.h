...
void task_10_3(double x, double y, double z, int b, const std::string& outputFile); // Викликає функцію s_calculation та переводе число b в двійкове і записує все в вихідний файл
